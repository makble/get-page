...
public class Reporter {
    ...
    // by default, a reporter don't supress anything
    public Reporter() {
        reportLevel = "1info";
    }
    ...
    private void ComposeContextMsg(int level, String msg, String prefix){
        System.out.println(prefix + getContextInfoWithLevel(level) + msg);
    }
